 ...
 * any)
 *
 * This can be used with the Larecoin extension by setting the `SEGMENT_HOST` environment
 * variable or config entry when building Larecoin.
 *
 * For example, to build Larecoin for use with this mock Segment server, you could set the
